...
class FamilyCategoryScreen extends StatefulWidget {
  const FamilyCategoryScreen({Key? key}) : super(key: key);

  @override
  State<FamilyCategoryScreen> createState() => _FamilyCategoryScreenState();
}

class _FamilyCategoryScreenState extends State<FamilyCategoryScreen> {
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if(snapshot.hasData) {
                      return GridView.builder(
                        ...
                        itemCount: snapshot
                            .data["Consulting"]["Family_counseling"].length,
