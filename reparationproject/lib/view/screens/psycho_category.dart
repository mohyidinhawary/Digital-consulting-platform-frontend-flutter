...
class PsychoCategoryScreen extends StatefulWidget {
  const PsychoCategoryScreen({Key? key}) : super(key: key);

  @override
  State<PsychoCategoryScreen> createState() => _PsychoCategoryScreenState();
}

class _PsychoCategoryScreenState extends State<PsychoCategoryScreen> {
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if(snapshot.hasData) {
                      return GridView.builder(
                        ...
                        itemCount: snapshot
                            .data["Consulting"]["Psychological_counseling"]
                            .length,
                        itemBuilder: (BuildContext context, int index) {
                          print(snapshot.data["Consulting"]
                              ["Psychological_counseling"][index]["name"]);
                          return InkWell(
                            onTap: () async {
