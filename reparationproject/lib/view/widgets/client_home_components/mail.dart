...
class CMail extends StatefulWidget {
  CMail({Key? key}) : super(key: key);

  @override
  _CMailState createState() => _CMailState();
}

class _CMailState extends State<CMail> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  int _selectedItem = 0;

  fetchClientsInbox() async {
